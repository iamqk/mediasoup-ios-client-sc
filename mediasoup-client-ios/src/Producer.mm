...
-(instancetype)initWithNativeProducer:(NSValue *)nativeProducer {
    ...
    if (self) {
        ...
        self._nativeTrack = [RTCMediaStreamTrack mediaTrackForNativeTrack:track factory:[[[RTCPeerConnectionFactory alloc] init]autorelease]];
    }
...
-(void)replaceTrack:(RTCMediaStreamTrack *)track {
    ...
    self._nativeTrack = [RTCMediaStreamTrack mediaTrackForNativeTrack:mediaTrack factory:[[[RTCPeerConnectionFactory alloc] init] autorelease]];
}
